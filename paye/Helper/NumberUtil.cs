namespace BaseSystemModel.Helper.Utils
{
    public class NumberUtil
    {
        #region convert number to farsi letter
        public static string ConvertNumberToFarsiLetterF1(string s)
        {
            string t = "";
            switch (s)
            {
        ...
        public static string ConvertNumberToFarsiLetterF2(string s)
        {
            string t = "";
        ...
        public static string ConvertNumberToFarsiLetterUtil(string s)
        {
            string t = "";
            if (s.Length == 0) return ("");
            ...
            t = ConvertNumberToFarsiLetterF1(s.Substring(0, 1)) + haveVa + ConvertNumberToFarsiLetterF2(s.Substring(1, 2));
            return t;
        }
        public static string CommaSeperatedPrice(decimal number)
        {
            return string.Format("{0:#,##0}", number);
        }
        public static string ConvertNumberToFarsiLetter(string s)
        {
            string t = "";
            ...
            {
                t = t + ConvertNumberToFarsiLetterUtil((s.Substring(0, 3))) + " هزار";
            ...
            if (!(s.Substring(3, 3) == "000"))
            {
                t = t + ConvertNumberToFarsiLetterUtil((s.Substring(3, 3))) + " ميليارد";
            ...
            {
                t = t + ConvertNumberToFarsiLetterUtil((s.Substring(6, 3))) + " ميليون";
                if (!(s.Substring(9, 6) == "000000")) t = t + " و";
            }

            if (!(s.Substring(9, 3) == "000"))
            {
                t = t + ConvertNumberToFarsiLetterUtil((s.Substring(9, 3))) + " هزار";
                if (!(s.Substring(12, 3) == "000")) t = t + " و";
            }

            if (!(s.Substring(12, 3) == "000"))
            {
                t = t + ConvertNumberToFarsiLetterUtil((s.Substring(12, 3)));
            }
